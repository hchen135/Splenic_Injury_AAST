...
train_images = sorted(
    glob.glob(os.path.join(data_dir, "imageFlipped", "*.nii.gz")))
train_labels = sorted(
    glob.glob(os.path.join(data_dir, "labelFlipped", "*.nii.gz")))
data_dicts = [
    {"image": image_name, "label": label_name, "name":image_name}
        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(model.state_dict(), os.path.join(
                    root_dir,"weights", "best_metric_model.pth"))
